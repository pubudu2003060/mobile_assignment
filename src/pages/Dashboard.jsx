...
export default function Dashboard() {
  ...
  const [profile] = useLocalStorage("smartcampus_profile", {
    name: "",
    studentId: "",
    department: "",
    semester: "",
      ...
      <div className="stats-grid stagger">
        ...
        <div className="stat-card animate-slide-up">
          <div className="stat-value">
            {completedCredits}/{totalCredits || 0}
          </div>
        ...
        <div className="stat-card animate-slide-up">
          <div
            ...
            style={{
              color: overdueAssignmentsCount > 0 ? "var(--color-danger)" : "",
            }}
          >
        ...
        >
          {todayLectures.length === 0 ? (
            ...
            todayLectures.map((lecture) => {
              const isOngoing = isCurrentlyOngoing(
                lecture.startTime,
                lecture.endTime,
              );
              return (
                <div key={lecture.id} className="card animate-slide-up">
                  ...
                  >
                    ...
                    {isOngoing && (
                      <span className="badge badge-progress">NOW</span>
                    )}
                  </div>
                  <h3
                    className="text-lg"
        ...
        >
          {upcomingDeadlines.length === 0 ? (
            ...
            upcomingDeadlines.map((assignment) => {
              const { text, isOverdue, isDueSoon } = getTimeRemaining(
                assignment.deadline,
              );
